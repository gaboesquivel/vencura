...
describe('SafeERC20', () => {
  ...
  describe('with usdt approval behaviour', () => {
    beforeEach(async function () {
  ...
  describe('with standard ERC1363', () => {
    beforeEach(async function () {
  ...
  describe('with ERC1363 that returns false on all ERC20 calls', () => {
    beforeEach(async function () {
  ...
  describe('with ERC1363 that returns false on all ERC1363 calls', () => {
    beforeEach(async function () {
  ...
  describe('with ERC1363 that returns no boolean values', () => {
    beforeEach(async function () {
  ...
  describe('with ERC1363 with usdt approval behaviour', () => {
    beforeEach(async function () {
...
function shouldOnlyRevertOnErrors() {
  ...
  describe('approvals', () => {
    ...
    describe('with non-zero allowance', () => {
      beforeEach(async function () {
        await this.token.$_approve(this.mock, this.spender, 100n)
      })
