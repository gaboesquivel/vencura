...
describe('AccessManager', () => {
  ...
  describe('getters', () => {
    ...
    describe('#getTargetFunctionRole', () => {
    ...
    describe('#getTargetAdminDelay', () => {
      describe('when the target admin delay is setup', () => {
    ...
    describe('#getRoleGrantDelay', () => {
      const roleId = 9248439n

      describe('when the grant admin delay is setup', () => {
  ...
  describe('admin operations', () => {
    ...
    describe('subject to a delay', () => {
      ...
      describe('#setGrantDelay', () => {
        ...
        describe('when increasing the delay', () => {
          const oldDelay = 10n
          const newDelay = 100n
        ...
        describe('when reducing the delay', () => {
    ...
    describe('not subject to a delay', () => {
      ...
      describe('#setTargetFunctionRole', () => {
        describe('restrictions', () => {
          beforeEach('set method and args', function () {
      ...
      describe('role admin operations', () => {
        ...
        describe('#grantRole', () => {
          ...
          describe('when the user is not a role member', () => {
          ...
          describe('when the user is already a role member', () => {
  ...
  describe('access managed self operations', () => {
    describe('when calling a restricted target function', () => {
    ...
    describe('when calling a non-restricted target function', () => {
  ...
  describe('access managed target operations', () => {
    describe('when calling a restricted target function', () => {
      const method = 'fnRestricted()'
  ...
  describe('#consumeScheduledOp', () => {
    ...
    describe('when caller is not consuming scheduled operation', () => {
    ...
    describe('when caller is consuming scheduled operation', () => {
  ...
  describe('#cancelScheduledOp', () => {
    ...
    testAsSchedulableOperation({
      scheduled: {
        before() {
          describe('when caller is the scheduler', () => {
            it('succeeds', async function () {
              await this.manager
                .connect(this.caller)
          ...
          describe('when caller is the role guardian', () => {
            it('succeeds', async function () {
              await this.manager
  ...
  describe('with Ownable target contract', () => {
    const roleId = 1n
    ...
    describe('Contract is managed', () => {
      describe('function is open to specific role', () => {
        beforeEach(async function () {
          await this.manager.$_setTargetFunctionRole(
            this.ownable,
            this.ownable.$_checkOwner.getFragment().selector,
      ...
      describe('function is open to public role', () => {
        beforeEach(async function () {
          await this.manager.$_setTargetFunctionRole(
            this.ownable,
            this.ownable.$_checkOwner.getFragment().selector,
