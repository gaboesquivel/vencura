...
describe('AuthorityUtils', () => {
  beforeEach(async function () {
    Object.assign(this, await loadFixture(fixture))
  })

  describe('canCallWithDelay', () => {
    describe('when authority does not have a canCall function', () => {
      beforeEach(async function () {
    ...
    describe('when authority has no delay', () => {
      beforeEach(async function () {
    ...
    describe('when authority replies with a delay', () => {
      beforeEach(async function () {
    ...
    describe('when authority replies with empty data', () => {
      beforeEach(async function () {
