...
const INSTANCES = {
  entrypoint: {
    ...
    abi: JSON.parse(
      fs.readFileSync(
        path.resolve(__dirname, '../bin/EntryPoint070.abi'),
        'utf-8',
      ),
    ),
    bytecode: fs.readFileSync(
      path.resolve(__dirname, '../bin/EntryPoint070.bytecode'),
      'hex',
    ),
  },
  sendercreator: {
    ...
    abi: JSON.parse(
      fs.readFileSync(
        path.resolve(__dirname, '../bin/SenderCreator070.abi'),
        'utf-8',
      ),
    ),
    bytecode: fs.readFileSync(
      path.resolve(__dirname, '../bin/SenderCreator070.bytecode'),
      'hex',
    ),
  },
}
