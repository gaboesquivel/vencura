...
describe('Governor', () => {
  for (const { Token, mode } of TOKENS) {
    ...
    describe(`using ${Token}`, () => {
      ...
      describe('frontrun protection using description suffix', () => {
        ...
        describe('without protection', () => {
          describe('without suffix', () => {
            shouldPropose()
          })

          describe('with different suffix', () => {
            beforeEach(function () {
              this.proposal = this.helper.setProposal(
                [
                  {
          ...
          describe('with proposer suffix but bad address part', () => {
            beforeEach(function () {
              this.proposal = this.helper.setProposal(
                [
                  {
        ...
        describe('with protection via proposer suffix', () => {
          beforeEach(function () {
            this.proposal = this.helper.setProposal(
              [
                {
