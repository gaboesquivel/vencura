...
description: "We need to select a framework for building the Vencura backend API that supports TypeScript, provides robust dependency injection, handles WebSockets, and integrates well with our monorepo structure."
---
