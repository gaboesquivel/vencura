...
description: "We need to select a framework for building frontend applications in our monorepo that supports React, provides server-side rendering and routing capabilities, and integrates well with our monorepo structure."
---
