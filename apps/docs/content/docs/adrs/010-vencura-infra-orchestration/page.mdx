...
description: "We need to select an infrastructure-as-code tool for managing Google Cloud Platform resources for the Vencura API deployment that supports type-safe declarative infrastructure definitions."
---
