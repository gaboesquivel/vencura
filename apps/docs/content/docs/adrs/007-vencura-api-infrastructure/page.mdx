...
description: "We need to select a deployment platform for the NestJS Vencura API that supports containerized deployments, handles WebSocket connections, and provides auto-scaling capabilities."
---
