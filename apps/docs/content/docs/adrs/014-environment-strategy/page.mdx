...
description: "We need a unified environment strategy across the monorepo that separates local development, staging, and production configurations and maps environments to appropriate blockchain networks."
---
