...
description: "We need a Next.js-native documentation framework that works seamlessly with our Next.js App Router architecture, supports MDX, and provides good developer experience out of the box."
---
