...
description: "E2E tests for the Vencura API require wallets to have native tokens to send transactions. We need an automated solution to fund test wallets with gas tokens without manual intervention."
---
