...
description: "We need to establish a design system approach for our frontend applications that provides consistent UI components, enables rapid prototyping, and integrates well with Next.js."
---
