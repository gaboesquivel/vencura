...
description: "Decision to use NestJS-first architecture with AI SDK Core for AI chatbot functionality, providing natural language interface and React/Next.js embeddability."
---
