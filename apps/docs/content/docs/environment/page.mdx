...
description: "This document describes the environment variable strategy across the monorepo, including how environment-specific configurations are loaded and used."
---
