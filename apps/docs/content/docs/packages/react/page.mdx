---
title: "@vencura/react"
description: "React hooks for Vencura API using TanStack Query. Provides type-safe hooks for interacting with the Vencura custodial wallet API. Built on top of @vencura/core using a contract-first approach with ts-rest for end-to-end type safety."
---
