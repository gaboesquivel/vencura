...
description: "This document outlines the comprehensive deployment and branching strategy for all systems in the Vencura monorepo, covering GitHub Flow, deployment targets (Vercel and Google Cloud), and hybrid deployment options."
---
