  ...
  return (
    <div
      className={`p-4 rounded-lg text-center ${
        status === "won" ? "bg-green-500/20 border-2 border-green-500" : "bg-red-500/20 border-2 border-red-500"
      }`}
    >
      <h2 className={`text-2xl font-bold mb-2 ${status === "won" ? "text-green-600" : "text-red-600"}`}>
