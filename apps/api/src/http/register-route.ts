...
type HandlerCtx<C extends Contract, Extra extends Record<string, any> = {}> = Extra &
  (C['body'] extends undefined ? {} : { body: InferBody<C> }) &
  (C['params'] extends undefined ? {} : { params: InferParams<C> }) &
  (C['query'] extends undefined ? {} : { query: InferQuery<C> }) &
  (C['headers'] extends undefined ? {} : { headers: InferHeaders<C> })
