---
title: "Introduction"
description: "Vencura - A TypeScript-first monorepo template for projects that need to publish SDKs, develop modular services with code reuse, and leverage AI-friendly documentation."
---
