...
- **@elysiajs/swagger** - OpenAPI/Swagger documentation generation
...
Swagger/OpenAPI documentation is automatically generated from your route definitions and Zod schemas. Once the server is running, access the interactive API documentation at:

- **Swagger UI**: `http://localhost:3077/swagger`

The documentation is automatically generated from your route `detail` objects and Zod schemas. Make sure to include `detail` objects in your routes for better documentation:
