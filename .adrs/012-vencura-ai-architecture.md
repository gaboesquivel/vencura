...
- [ADR 002: Vencura API Framework](./002-vencura-api-framework.md) - NestJS framework decision
- [ADR 010: Vencura Infrastructure Orchestration](./010-vencura-infra-orchestration.md) - Deployment strategy
- [ADR 011: Vencura API ORM Selection](./011-vencura-api-orm.md) - Database ORM decision
