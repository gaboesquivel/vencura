...
Provides type-safe API clients for the Vencura Wallet backend (auth, wallets, account, ai, etc.) with automatic authentication and token refresh. Works in Node.js, Next.js, and edge runtimes.
